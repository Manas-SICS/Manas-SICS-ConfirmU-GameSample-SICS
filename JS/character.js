...
export class MainCharacter {
    constructor(game) {
        ...
        this.x = -220;
        this.y = 173;
        this.mcimage = document.getElementById('mc-sprite');
        this.fps = 10;
    ...
    draw(context) {
        context.drawImage(this.mcimage, this.frameX * this.spriteWidth, this.frameY * this.spriteHeight, this.spriteWidth, this.spriteHeight, this.x, this.y, this.width, this.height,)
    }
}
